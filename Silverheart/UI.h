...
public:
	...
	void update(float mx, float my, float width, float height);
	void remove();

	void setScissor(float x1, float y1, float x2, float y2);
	void setOnClick(std::string file, std::string function);
private:
	int bgID;
...
public:
	...
	void markWindowForRemoval(std::string windowID);
